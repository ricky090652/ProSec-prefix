...
| checkpoint | 安全性 Δ | 功能性 Δ | 備註 |
|---|---|---|---|
| 300 | **−2.39** | **−0.18** | HumanEval −3.66 / js +3.73 / cpp −0.62 |
| 1500 | 未測 | HumanEval −67.07 | 崩潰 |
...
下一步：HumanEval 掃 checkpoint-600，pass@1 ≥ 60% 就跑全量安全性。那一臂有機會同時
達到論文級安全性與接近零的功能性代價——目前所有臂都沒做到的「兩軸都改善」。
