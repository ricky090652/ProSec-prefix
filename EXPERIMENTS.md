...
**目前進度**：**S2 停損點觸發**（LoRA −18.80 vs Prefix −6.20，差 12.6pt > 10）· 但 LoRA 有註解率暴增 48.6% 與 14.4% 截斷兩個疑點待排除，先別轉向
**上次更新**：2026-08-30（D-screen2 + 停損判定）
...
> LoRA（每組約 87 分鐘）：
>
> | lr | chosen Δ | rejected Δ | 壓rej/壓chosen | margin Δ (成長%) | acc late | grad 峰值 | chosen 每 token 保留 |
> |---|---|---|---|---|---|---|---|
> | **5e-6** ✅ | −0.147 | −0.683 | **4.63** | +0.535 (+5298%) | 0.724 | 58 | **99.3%** |
> | 2e-5 | −3.417 | −8.074 | 2.36 | +4.657 (+3432%) | 0.975 | 106 | 86.0% |
> | 5e-5 | −17.006 | −33.062 | 1.94 | +16.06 (+1929%) | 0.989 | 366 | 47.0% |
> | 1e-4 | −35.625 | −66.905 | 1.88 | +31.28 (+1594%) | 0.995 | 569 | 20.0% |
> | 2e-4 | −32.101 | −76.197 | 2.37 | +44.10 (+1023%) | 0.997 | 608 | 21.2% |
>
> Prefix（每組約 55 分鐘）：
>
> | lr | chosen Δ | rejected Δ | 壓rej/壓chosen | margin Δ (成長%) | acc late | grad 峰值 | chosen 每 token 保留 |
> |---|---|---|---|---|---|---|---|
> | 5e-6 | **+0.040** | −0.015 | ∞ | +0.055 (+86%) | 0.554 | 45 | 96.8% |
> | 2e-5 | **+0.034** | −0.098 | ∞ | +0.132 (+177%) | 0.612 | 34 | 96.8% |
> | **5e-5** ✅ | −0.058 | −0.366 | **6.30** | +0.307 (+326%) | 0.692 | 67 | 96.4% |
> | 1e-4 | −0.307 | −0.805 | 2.62 | +0.498 (+388%) | 0.730 | **3722** ⚠️ | 95.4% |
> | 2e-4 | −3.413 | −4.193 | 1.23 | +0.781 (+383%) | 0.647 | 3672 | 83.1% |
>
